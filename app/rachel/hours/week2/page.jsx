...
import { StudentItemTwo } from "@components/app/components/StudentItem"
...
export const RachelHoursWeekTwo = ({closeModal}) => {
  ...
  console.log("logging Rachel's students", rachelStudents)
    ...
    <>
        <div className="flex flex-col w-full">
            <div className="px-16 h-20 bg-red-200 flex items-center font-semibold col-span-2">
                <Link href="/rachel/hours/week1"><button>Back To Week 1</button></Link>
            ...
            <form className="px-16 py-10 border-r-2 border-gray-100" onSubmit={handleSubmitWeekOne}>
                <p className="mb-8 text-center text-green-700 font-bold"><span className="me-4">Week 2 Pay Period:</span>{weekOnePayPeriod ? `${weekOnePayPeriod.start} - ${weekOnePayPeriod.end}` : "d"}</p>
