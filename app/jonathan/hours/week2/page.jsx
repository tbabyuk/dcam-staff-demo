...
export const JonathanHoursWeekTwo = () => {
  ...
  const handleSubmitWeekTwo = async (e) => {
    ...
    try {
        ...
        setTimeout(() => {
          router.push("/jonathan/hours/success")
        }, 3000)
    } catch(error) {
    ...
    <>
        <div className="flex flex-col w-full max-w-[100%] md:ms-[200px] bg-[url('/images/main_bg.jpg')] bg-cover bg-center">
            <div className="page-header px-3 md:px-6 h-20 bg-gray-300 flex justify-between items-center col-span-2">
                <Link href="/jonathan/hours/week1"><button className="dcam-btn-rounded flex items-center"><FiArrowLeft className="inline-block me-1" />Week 1</button></Link>
